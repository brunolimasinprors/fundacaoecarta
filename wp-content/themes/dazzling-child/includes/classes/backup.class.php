...
/**
 * Classe desenvolvida para gerar backups de bases de dados mysql, 
 * levando em consideração a quantidade de dias que será mantido o histórico de backups
 * e a quantidade de meses que o último backup de cada mês ficará armazenado.
 * 
 * @author bruno.lima
 */
class backup {
