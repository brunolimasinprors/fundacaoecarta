<?php
/*
Plugin Name: Mantém a ordem de exibição das categorias (Customizado)
Plugin URI: http://www.nsp-code.com
Description: Mantém a ordem de exibição das categorias (Customizado)
Version: 1.3.4
Author: Mantém a ordem de exibição das categorias (Customizado)
