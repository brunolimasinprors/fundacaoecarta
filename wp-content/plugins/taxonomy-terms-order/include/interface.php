        ...
        if (!taxonomy_exists($taxonomy))
            ...
            <div class="wrap">
                <div class="icon32" id="icon-edit"><br></div>
                    <h2>
                        <?php
                        if ($tipoOrdem == "post_tag"){
                           echo "Reordenar Itens Menu Lateral"; 
                        }else{
                           echo "Reordenar Projetos";                                                         
                        }
                        ?>
                    </h2>
                     ...
                     if ($post_type != 'post')
                        ...
                        if (count($post_type_taxonomies) > 1){
                            ...
                            <table cellspacing="0" class="wp-list-taxonomy">
                                <thead>
                                    <tr>
                                        <th style="" class="column-cb check-column" id="cb" scope="col">&nbsp;</th><th style="" class="" id="author" scope="col"><?php _e( "Taxonomy Title", 'to' ) ?></th><th style="" class="manage-column" id="categories" scope="col"><?php _e( "Total  Posts", 'to' ) ?></th>    
                                    </tr>
                                </thead>
                                <tbody id="the-list">
                                    <?php
                        ...
                        <div id="post-body">                    
                            <ul class="sortable" id="tto_sortable">
                                <?php 
                                    ...
                                    //print_r($taxonomy);
                                    if ($tipoOrdem == "post_tag"){
                                       listTags($tipoOrdem); //> Tags | Itens de menu lateral  	                                         
                                    }else{
                                        listTerms($taxonomy);  //> projetos
                                    }
                                ?>
                            </ul>
                            <div class="clear"></div>
