...
class Sharing_Admin {
	...
	public function sharing_head() {
		...
		wp_enqueue_style( 'sharing-admin', WP_SHARING_PLUGIN_URL.'admin-sharing.css', array(), null, false );
		wp_enqueue_style( 'sharing', WP_SHARING_PLUGIN_URL.'sharing.css', array(), null, false );
		wp_enqueue_script( 'sharing-js-fe', WP_SHARING_PLUGIN_URL . 'sharing.js', array(), null );
